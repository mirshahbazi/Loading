package loading.mam.com.mamloadingview;
...
/**
 * Created by MAM on 15/7/27.
 */
public class MAMBallView extends View {
    ...
    public MAMBallView(Context context) {
        super(context);
        init();
    }

    public MAMBallView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MAMBallView(Context context, AttributeSet attrs, int defStyleAttr) {
